...
The area, again, is unsurprisingly the same as *1e* and its subsequent transformations (*3a* and *3b*). This transformation takes on characteristics of both *3a* and *3b*, being the skinniest and longest of the generations.
...
#| size: "scriptsize"
#| code-fold: FALSE
(leaning.ladder = data.frame(x = T[,1],y=T[,2]))
```
